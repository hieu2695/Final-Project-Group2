...
x_train_over, y_train_over = torch.from_numpy(np.asarray(x_train_over)), torch.from_numpy(np.asarray(y_train_over))
...
for epoch in range(N_EPOCHS):
    ...
    if epoch == 0:
        ...
        torch.save(best_model_wts, "Resnet50_model.pt")
