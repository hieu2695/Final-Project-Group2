...
{ 'params': model[2].features.conv0.parameters(),'lr': LR/ 5},
{ 'params': model[2].features.norm0.parameters(),'lr': LR/5},
{ 'params': model[2].features.norm5.parameters(), 'lr': LR},
{ 'params': model[2].features.pool0.parameters(),'lr': LR/ 5},
{ 'params': model[2].features.denseblock1.parameters(), 'lr': LR/ 5},
{ 'params': model[2].features.denseblock2.parameters(), 'lr': LR/ 5},
{ 'params': model[2].features.denseblock3.parameters(), 'lr': LR/ 3},
{ 'params': model[2].features.denseblock4.parameters(), 'lr': LR/ 3},
{ 'params': model[2].features.transition1.parameters(), 'lr': LR/ 5},
{ 'params': model[2].features.transition2.parameters(), 'lr': LR/ 3},
{ 'params': model[2].features.transition3.parameters(), 'lr': LR},
{ 'params': model[2].classifier.parameters(),'lr': LR}], lr=LR)

#%%----------------------------------- Training and fine-tuning model -------------------------------------------------------------
path ="../Model/model_densenet121.pt"
...
plt.title("Learning curve of densenet121 with base learning_rate={:.4f}".format(LR))
plt.legend(loc='best')
plt.xticks(np.arange(0, max(inds)+2, 3))
plt.savefig("../Figure/learning_curve_densenet121.pdf")
plt.show()