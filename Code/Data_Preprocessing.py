...
#%%------------ Load data --------------------------
x = np.array(np.load("../processed_data/Npy/inputs.npy", allow_pickle=True), dtype="float32")
y = np.array(np.load("../processed_data/Npy/targets.npy", allow_pickle=True), dtype="float32")
